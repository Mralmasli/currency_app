package com.azercell.coreui.state

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.azercell.coreui.common.collectIn
...
interface CombinedStateDelegate<UiState : az.unibank.coreui.state.State, State : az.unibank.coreui.state.State, Event> :
 ...
 */
class CombinedStateDelegateImpl<UiState : az.unibank.coreui.state.State, State : az.unibank.coreui.state.State, Event>(
...
inline fun <UiState : az.unibank.coreui.state.State, State : az.unibank.coreui.state.State, Event> CombinedStateDelegate<UiState, State, Event>.collectInternalState(
    coroutineScope: CoroutineScope,
...
context(ViewModel)
fun <UiState : az.unibank.coreui.state.State, State : az.unibank.coreui.state.State, Event> CombinedStateDelegate<UiState, State, Event>.asyncUpdateInternalState(
